...
Jurnal is an open-access academic journal management platform supporting manuscript submission, double-blind peer review workflows, issue publishing, and DOI indexing.

Developed to provide a robust, clean, and production-ready architecture tailored for Academic Publishing & Open Access requirements.

---

## âœ¨ Key Features

- **Online Manuscript Submission & Author Tracking Dashboard**
- **Double-Blind Peer Reviewer Assignment & Feedback Management**
- **Issue Archiving, Volume Bundling & PDF Viewer Integration**
- **Bibliographic Citation Export (BibTeX, RIS, EndNote)**
- **Editorial Board & Reviewer Directory**
...
5. **Run Local Development Server**
   `ash
   php artisan serve
   # or start via Laragon virtual host: http://jurnal.test
   `
...
Contributions, issues, and feature requests are welcome! Feel free to check the [issues page](https://github.com/raphlv/jurnal/issues).
